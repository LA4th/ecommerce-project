...
export default function TheHeader ({ inputSearch }) {
  ...
  return (
    <>
      {/* DESKTOP VIEW */}
      <div className="relative bg-vintageWhite border-b-2 border-vintageGray p-1.5 hidden w-full max-w-full md:flex flex-row items-center justify-between gap-x-5">
        {/* LOGO */}
      ...
      {/* MOBILE VIEW */}
      <div className="bg-vintageWhite border-b-2 border-vintageGray p-1.5 relative md:hidden w-full max-w-full flex flex-col items-center justify-between gap-y-5">
